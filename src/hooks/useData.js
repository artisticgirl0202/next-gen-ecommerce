            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!productId)
                            return [2 /*return*/, []];
                        return [4 /*yield*/, (0, recommend_1.fetchHybridRecommendations)(productId, topN)];
                    case 1:
                        res = _b.sent();
                        return [2 /*return*/, (_a = res.recommendations) !== null && _a !== void 0 ? _a : []];
                }
            });
        }); },
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        queryClient.setQueryData(["cart"], function (old) { return __spreadArray(__spreadArray([], (old || []), true), [
                            newItem,
                        ], false); });
